...
-- monthly invoices (no half-day / hourly / custom rate logic). Iter 22 cleanup
-- (commits c7b1a7e + 5a1f5d3) removed every code reference. Now collapse the
-- enum at the DB layer to the single supported value.
--
