  ...
  private async createConsentFormsPdf(
    ...
    return new Promise((resolve, reject) => {
      ...
      doc
        ...
        .font('Helvetica')
        .fillColor('#666666')
        .text('Required for Enrollment - Please Read Carefully', { align: 'center' });
      ...
      this.renderSection(doc, 'SECTION 1: POPIA CONSENT (Protection of Personal Information Act)');
      ...
      this.renderSection(doc, 'SECTION 2: MEDICAL CONSENT AND EMERGENCY TREATMENT');

      doc.fontSize(10).font('Helvetica');
      doc.text(
        'In the event of a medical emergency where I cannot be contacted, I hereby authorize the staff of ' + crecheName + ' to:\n\n' +
      ...
      doc.text(
        ...
        '• Indemnify and hold harmless ' + crecheName + ', its staff, and representatives from any claims, damages, or losses arising from:\n' +
      ...
      doc.fontSize(10).font('Helvetica-Bold').text('PARENT/GUARDIAN SIGNATURE:', 50, sigY);
      doc.moveDown(2);
      doc.fontSize(10).font('Helvetica');
      ...
      doc.moveDown(1);
      doc.fontSize(10).font('Helvetica');
      doc.text('Received by: _________________________ Date: _________________________', 50);
      doc.moveDown(0.5);
