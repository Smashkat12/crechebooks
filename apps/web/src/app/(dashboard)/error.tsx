 ...
 * Catches thrown errors from reconciliation, staff, parents/:id, and other
 * dashboard pages. Renders within the existing dashboard layout so the
 * sidebar and nav chrome remain visible.
 */
