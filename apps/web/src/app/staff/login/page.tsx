      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 to-background dark:from-emerald-950/20 p-4">
        <Card className="w-full max-w-md">
          ...
          <CardContent className="space-y-4 text-center text-muted-foreground">
            <p>
              Click the link in the email to sign in to your staff portal. The
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 to-background dark:from-emerald-950/20 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-base mt-2">
            Enter your work email to receive a magic link to sign in
          </CardDescription>
        </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                id="email"
                type="email"
                placeholder="your.name@workplace.com"
                value={email}
              ...
              <p className="text-sm text-muted-foreground">
                Use the email address registered with your employer
              </p>
            </div>
          </CardContent>
