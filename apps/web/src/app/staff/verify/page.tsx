...
function VerifyContent() {
    ...
    const verifyToken = async () => {
      try {
        const response = await fetch(
          `${API_URL}/api/v1/auth/staff/verify`,
          {
            method: 'POST',
            headers: {
        ...
        // Store session token in localStorage for staff portal
  ...
  if (state === 'loading') {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 to-background dark:from-emerald-950/20 p-4">
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 to-background dark:from-emerald-950/20 p-4">
        <Card className="w-full max-w-md">
          ...
          <CardContent className="text-center">
            <Loader2 className="h-6 w-6 text-emerald-600 dark:text-emerald-400 animate-spin mx-auto" />
          </CardContent>
        </Card>
      </div>
    );
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 to-background dark:from-emerald-950/20 p-4">
        <Card className="w-full max-w-md">
          ...
          <CardFooter className="flex flex-col gap-4">
            <Button asChild className="w-full h-12 bg-emerald-600 hover:bg-emerald-700" size="lg">
